...
const navItems = [
  ...
  { name: 'Mess Registration', path: '/student/registration' },
  { name: 'View Menu', path: '/student/menu' },
  { name: 'Submit Feedback', path: '/student/feedback' },
  { name: 'View Bill', path: '/student/bill' },
  { name: 'Apply Rebate', path: '/student/rebate' }
];
